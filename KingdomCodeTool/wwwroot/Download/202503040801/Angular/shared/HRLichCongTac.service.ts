...
import { HRLichCongTac } from './HRLichCongTac.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class HRLichCongTacService extends BaseService{
    ...
    List: HRLichCongTac[] | undefined;
    ListFilter: HRLichCongTac[] | undefined;
    FormData!: HRLichCongTac;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "HRLichCongTac";
    }
}
